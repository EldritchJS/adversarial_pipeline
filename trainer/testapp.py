...
def main(args):
    ...
    try:
        ...
        pass
    path = get_file(model_filename, extract=False, path='/home/jschlessman', url=modelurl)
    ...
    model.fit(X_train, y_train, nb_epochs=83, batch_size=50)
...
if __name__ == '__main__':
    ...
    parser.add_argument(
            ...
            default='OhQaquFPk20AAAAAAACLRT15cLzvF5ekIq2NFTAGirUlbAd7lLqkMoOqbVwnOFNp')
    parser.add_argument(
            '--dbhost',
